...
## GoogleNet
主要由9个Inception模块, 其中 中间层增加了两个额外的softmax层, 但这部分在测试中是不需要的.(用于计算中间损失?)

<img src=https://s2.loli.net/2024/05/08/pM81TJFateVC4G3.png width='50%'>