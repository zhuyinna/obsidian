...
由于不再需要满足markov性质, 所以上述可以将t-1改为s, 所以采样过程可以写成
$$
x_{s-1}=N(\sqrt{\overline{\alpha}_{s-1}}x_0+\sqrt{1-\overline{\alpha}_{s-1}-\sigma^2}\frac{x_s-\sqrt{\alpha}_{s-1}x_0}{1-\overline{\alpha}_s},\sigma^2I)
$$
