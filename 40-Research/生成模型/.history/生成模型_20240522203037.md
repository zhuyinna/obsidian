...
5. 缺陷
在对$p_\theta(x_{t-1}|x_t,x_0)$的推导中, 使用了一阶markov假设, 使得$p_\theta(x_{t-1}|x_t,x_0)=p_\theta(x_{t-1}|x_t)$, 因此重建步很长, 速度慢. 为什么不能跳步? 因为在求:
$$
P(x_{t-1}|x_t,x_0) = \frac{P(x_t|x_{t-1})P(x_{t-1}|x_0)}{}
$$
