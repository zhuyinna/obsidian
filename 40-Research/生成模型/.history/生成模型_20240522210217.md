...
\left\{
\begin{aligned}
x_t = & \sqrt{\overline{{\alpha_t}}}(x_{0})+\sqrt{1-\overline{\alpha_t}}\epsilon^{'})+\sigma_t\epsilon_t \\
x_{t-1} = & kx_0+m(\sqrt{\overline{{\alpha_t}}}(x_{0})+\sqrt{1-\overline{\alpha_t}}\epsilon^{'})+\sigma_t\epsilon_t
\end{aligned}
\right.
$$
其中$\epsilon_t
